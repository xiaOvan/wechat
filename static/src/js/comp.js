...
var CommentForm = React.createClass({displayName: 'CommentForm',
	...
	window.location='http://gafe.chinacloudapp.cn/comments';	
    },
        ...
        return (
            React.createElement("div", {className: "comment-form", onSubmit: this.handleSubmit}, 
                React.createElement("form", null, 
                    ...
                    React.createElement("p", null, React.createElement("input", {type: "submit", value: "submit"}),React.createElement("input", {type: "button", onClick:this.handleJump,value: "查看所有留言"}))
                )
            )
        );
    }
